...
**1.3.7** Enter the WSDL value for the NetSuite APIs in the *Connection Properties*:
...
**3.1.17** Try a different `VendorPaymentId` and see what happens ...set your input id to _11411_
...
```javascript
{
  ...
  "CheckNumber": "2129",
  "CheckAmount": "755.0",
  "CheckPostingDate": "2017-05-04T00:00:00.000-07:00",
  "AccountBalance": "4739172.21"
}
```
