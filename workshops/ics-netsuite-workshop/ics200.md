...
Note 2: The *JSON* radio button will automatically be selected in **type of payload** 

![](images/200/image031.png)

**2.1.10** Enter the following JSON into the **Enter Sample JSON**, then click **Ok**

Since we are looking up Vendor Payments in NetSuite, we need to pass in the Id for a record to query.
