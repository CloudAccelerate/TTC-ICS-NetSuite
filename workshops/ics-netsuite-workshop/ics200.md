...
**2.3.4** To find out how the actual variable display name maps to the business object attribute, we can reference the NetSuite documentation for VendorPayment which can be found here: <a href="http://www.netsuite.com/help/helpcenter/en\_US/srbrowser/Browser2016\_2/schema/record/vendorpayment.html">http://www.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2016_2/schema/record/vendorpayment.html</href>
...
Below is a table showing the NetSuite UI VendorPayment *Labels* with their corresponding business object attribute *Names* and the *Target Variable Name* it needs to be mapped to:
...
**2.6.3** If this is the first time you have have opened an ICS WSDL in the browser, you may be prompted to enter your username/password for ICS in a pop-up login window.
